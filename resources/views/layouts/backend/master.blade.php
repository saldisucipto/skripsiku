...
<head>
	<title>Dashboard Admin | Ecommerce System</title>
	<meta charset="utf-8">
	...
	<link rel="stylesheet" href="{{asset('assets/vendor/clorofiladmin/css/demo.css')}}">
	<!-- GOOGLE FONTS -->
	<link href="https://fonts.googleapis.com/css?family=Source+Sans+Pro:300,400,600,700" rel="stylesheet">
	<!-- ICONS -->
	<link rel="apple-touch-icon" sizes="76x76" href="{{asset('assets/vendor/clorofiladmin/img/apple-icon.png')}}">
	<link rel="icon" type="image/png" sizes="96x96" href="{{asset('assets/vendor/clorofiladmin/img/favicon.png')}}">
</head>
